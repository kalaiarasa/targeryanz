     ...
     function validateForm()
      {
          ...
          {
            $("#msg-e").show();
             $("#details-e").text("Community Name is Required");
             $("html, body").animate({ scrollTop: 0 }, "slow");
             $('#msg-e').delay(5000).fadeOut();
             return false;
          }
    ...
    <div class="row" style="margin-top:4px;">
           ...
           <div class="row">
               ...
               <div class="col-md-3">
                   ...
                   <?php 
                       ...
                       <div class="clrRed"  multiple="" md-auto-hide="false" aria-live="assertive">
                           <!-- ngMessage:  -->
                       </div>
                   </div>
               </div>
               ...
               <!-- <a href="http://192.169.158.38:90" class="btn btn-primary col-md-null">
       ...
       <div class="col-md-8 md-whiteframe-24dp" style="border: 1px solid rgb(186, 186, 186); min-height: 100px;"  aria-hidden="false">
           ...
           <div class="row top5">
               ...
               <div class="col-md-3">
                   <div class="gap5">
                       <input id="a_no" name="a_no"  type="number" class="text-center form-control input-lg" >
                   </div>
               </div>
           ...
           <div class="col-md-2 text-right" style="margin-left: 7%;">
                   ...
                   <div class="row">
                       <div class="col-md-4">
                           <div class="form-group">
                               ...
                               <div  multiple="" md-auto-hide="false" aria-live="assertive">
                                   <!-- ngMessage:  --><div >
                                       Candidate name 
                                   </div>
                               </div>
                   ...
                   <div class="col-md-4">
                       <div class="form-group">
                           ...
                           <select id="district" class="form-control" name="ddDistrict"  ="" >
                               ...
                               <!-- ngRepeat: r in tblDistrict --><option    value="ARIYALUR">
                                   ARIYALUR
               ...
               <!-- ngIf: BRName=='BA' || BRName=='AR' -->
               <div class="row top15">
                   <div class="col-md-3">
                       <div class="form-group">
                           <label>Qualifying Examination</label>
                           <select id="qualifying_exam" class="form-control" name="rbQE"   ><option value="" selected></option>
                   ...
                   <div class="col-md-5">
                       <div class="form-group">
                           ...
                           <select id="name_of_board" class="form-control " name="ddBoard"   ><option value="" selected></option>
                               <!-- ngRepeat: r in tblBoard --><option   value="Tamilnadu-Tamilnadu Board of Higher Secondary Education">
               ...
               <div class="row">
                   <div class="col-md-4">
                       <div class="form-group">
                           <!-- ngIf: BRName!='BA' && BRName!='AR' -->
                           <label>HSC Register Number</label><!-- end ngIf: BRName!='BA' && BRName!='AR' -->
                           <!-- ngIf: BRName=='BA' || BRName=='AR' -->
                   ...
                   <div class="col-md-4">
                       <div class="form-group">
                           ...
                           <label>
                               ...
                               <!-- ngIf: BRName!='BA' && BRName!='AR' --><label >HSC Vocational</label><!-- end ngIf: BRName!='BA' && BRName!='AR' -->
                               <!-- ngIf: BRName=='BA' || BRName=='AR' -->
                           </label>
                           <div class="clrRed"  multiple="" md-auto-hide="false" aria-live="assertive">
                               <!-- ngMessage:  -->
               ...
               <table class="w100p" border="1" cellpadding="0" cellspacing="0">
                   <!--<tr ng-if="stud.DPI_MATCHED == 'Y' ">
                       <td colspan="4" class="text-left">
                           <blink><label class="text-success">Note * : DPI data matched successfully for this candidate</label></blink>
                       </td>
                   </tr>-->
                   <tbody><!-- ngIf: BRName=='BA' || BRName=='AR' -->
                   <tr>
                           ...
                           <div class="form-group text-center">
                               <table class="w100p" cellspacing="0">
                                   <tbody><tr>
                                       <td colspan="3">
                                           <div style="text-align: center;">
                                               ...
                                               <!-- ngIf: stud.HSC_GROUP == 'General' -->
                                               <!-- ngIf: stud.HSC_GROUP == 'Vocational' && (BRName != 'BA' && BRName != 'AR') -->
                                               <!-- ngIf: stud.HSC_GROUP == 'Vocational' && (BRName == 'BA' || BRName == 'AR') -->
                                           </div>
                                       </td>
                                   </tr>
                                   <tr>
                                       ...
                                       <td class="w50p">
                                           <div style="text-align: center;">
                                               <!-- ngIf: (stud.HSC_GROUP == 'Vocational' && (BRName == 'BA' || BRName == 'AR'))?0:null -->
                                               ...
                                               </select><!-- end ngIf: (stud.HSC_GROUP == 'Vocational' && (BRName == 'BA' || BRName == 'AR'))?0:null -->
                                               <!-- ngIf: stud.HSC_GROUP == 'Vocational' && (BRName == 'BA' || BRName == 'AR') -->
