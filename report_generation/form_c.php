...
class PDF extends FPDF{
    ...
    function set_records($n,$bn,$san,$swc,$gov,$mgt,$min,$lap,$nri,$goi,$for,$tot,$fgo,$fgs,$fgt,$t1,$t2,$t3){
        ...
        $this->Cell(90,10,$bn,1,0);
        $this->Cell(10,10,$san,1,0);
        $this->Cell(10,10,$swc,1,0);
        $this->Cell(10,10,$gov,1,0);
        $this->Cell(10,10,$mgt,1,0);
        $this->Cell(10,10,$min,1,0);
        $this->Cell(13,10,$lap,1,0);
        $this->Cell(13,10,$nri,1,0);
        $this->Cell(13,10,$goi,1,0);
        $this->Cell(13,10,$for,1,0);
        $this->Cell(10,10,$tot,1,0);
        $this->Cell(10,10,$fgo,1,0);
        $this->Cell(13,10,$fgs,1,0);
        $this->Cell(13,10,$fgt,1,0);
        $this->Cell(10,10,$t1,1,0);
        $this->Cell(10,10,$t2,1,0);
        $this->Cell(10,10,$t3,1,1);
    }

    function set_total($san,$swc,$gov,$mgt,$min,$lap,$nri,$goi,$for,$tot,$fgo,$fgs,$fgt,$t1,$t2,$t3){
        $this->SetFont('Arial','B',10);
        $this->Cell(10,10,'',1,0);
        $this->Cell(90,10,'TOTAL',1,0);
        $this->Cell(10,10,$san,1,0);
        $this->Cell(10,10,$swc,1,0);
        $this->Cell(10,10,$gov,1,0);
        $this->Cell(10,10,$mgt,1,0);
...
$pdf->Cell(90,10,'Branch Name',1,0);
$pdf->Cell(10,10,'SAN',1,0);
$pdf->Cell(10,10,'OC-M',1,0);
$pdf->Cell(10,10,'OC-F',1,0);
$pdf->Cell(10,10,'BC-M',1,0);
$pdf->Cell(10,10,'BC-F',1,0);
$pdf->Cell(13,10,'BCM-M',1,0);
$pdf->Cell(13,10,'BCM_F',1,0);
$pdf->Cell(13,10,'MBC-M',1,0);
$pdf->Cell(13,10,'MBC-F',1,0);
$pdf->Cell(10,10,'SC-M',1,0);
$pdf->Cell(10,10,'SC-F',1,0);
$pdf->Cell(13,10,'SCA-M',1,0);
$pdf->Cell(13,10,'SCA_F',1,0);
$pdf->Cell(10,10,'ST-M',1,0);
$pdf->Cell(10,10,'ST-F',1,0);
